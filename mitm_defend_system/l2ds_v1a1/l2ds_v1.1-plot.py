...
def RealtimePloter(arg):
      ...
      ax.axis([CurrentXAxis.min(),CurrentXAxis.max(),0,50])
      manager.canvas.draw()
      #manager.show()
...
def sniffing():
    ...
    while True:
        ...
        sniff(iface="eth0", prn=get_packet_type, count=0, timeout=1.5)
        ...
        print "->>Total Network Traffic Per Second : %6d /s" %countpers
        time += 1
