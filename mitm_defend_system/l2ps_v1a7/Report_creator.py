...
def main():
    try:
        ...
        html_generate('HTML/FYP Overview.html', list_pl, percentage_logs_all, percentage_report_all)
        html_generate('HTML/FYP Overview-ThisMouth.html', list_pl_month, percentage_logs_this_month, percentage_report_this_month)
        html_generate('HTML/FYP Overview-Today.html', list_pl_today, percentage_logs_today, percentage_report_today)

        html_table('HTML/FYP Devices.html')
        html_table('HTML/FYP Logs.html')
        html_table('HTML/FYP Reports.html')
