...
import sys, pl, scannetwork
import L2PS_v1a7, Config,RS_connector,Report_creator
import twograph
import MySQLdb
...
class Ui_StackedWidget(QStackedWidget):
    ...
    #### Log page
        ...
        self.WebBox.load(QUrl("/root/PycharmProjects/GUI/HTML/FYP Home.html"))
...
class syncThread(QThread):
    ...
    def run(self):
        self.ps0 = Process(target=L2PS_v1a7.main, args=(q, l, 'eth0', q2, l2, q3))
        self.ps0.start()
